...
## 10. Добавлено во втором заходе

**Журнал.** Шаблон ленты `home.html`, разметка BlogPosting с автором. Четыре
готовые статьи паттернами по 450–535 слов: что надеть на семейную съёмку, как
пройти съёмку с двухлеткой, где снимать в Лос-Анджелесе, как попасть в детское
модельное агентство. Последняя — под самый крупный запрос, который у нас уже
закрыт услугой.

**Новорождённые — девятая услуга.** $700 за два часа дома, lifestyle без
реквизита. Плюс пакет «первый год»: новорождённый, полгода, год за $1800 вместо
$2100. Услуга добавлена в сетку услуг, цены, витрину галерей, раздел портфолио
и в разметку LocalBusiness.

**Сезонные мини-сессии.** Отдельная страница: двадцать минут, одна локация,
десять семей, $295. Даты в квадратных скобках — меняешь каждый сезон.

**Страница подготовки** `/prepare-for-your-session/` — тайминг вокруг сна,
одежда, что взять, что происходит в день съёмки, пять вопросов-ответов.

**Альбомы и печать.** Альбом $490, рамы от $180, праздничные открытки $2.20 за
штуку от 25. Цены проверь у своей типографии.

**Три страницы локаций** с настоящей практикой: Эль-Матадор (приливы, лестница,
парковка), Гриффит-парк (Ферн-Делл против обсерватории), Арройо в Пасадене
(ровные дорожки, тень, для новорождённых и бабушек). Адрес встречи кладётся в
отрывок страницы и превращается в разметку Place.

**Календарь записи.** Блок встраивает Calendly или Acuity по ссылке из
настроек, без ссылки показывает телефон и почту.

### Что нужно от тебя по этому блоку

- Подтвердить цены на альбомы, рамы и открытки у типографии
- Настоящие даты ближайшего дня мини-сессий
- Ссылка Calendly или Acuity и ссылка на отзывы в гугле
- Фотографии для трёх страниц локаций и для статей журнала
- Проверить цену на новорождённых: я поставил $700, как у беременности


---

## 11. Тексты услуг стали паттернами

Все девять страниц услуг теперь лежат готовыми паттернами в теме: семья, дети
и подростки, дни рождения, свадьбы, беременность, новорождённые, портреты
родителей, портреты взрослых, модельное портфолио. В каждой — текст из
раздела 4 выше, блок «что входит» с настоящей ценой и от четырёх до шести
вопросов-ответов, которые сами превращаются в разметку FAQPage.

Скрипт `tools/setup-thereyare.php` вставляет их автоматически, так что руками
остаётся написать только «О студии» и юридические страницы.

Вопросы подобраны под реальные поисковые запросы: сколько стоит семейная
съёмка в Лос-Анджелесе, сколько длится, дома или на улице, можно ли с
бабушками и собакой, когда снимать беременность, чем цифровые снимки для агентства отличаются от
портфолио, сколько стоит свадебный фотограф. На странице модельного портфолио
отдельным блоком написано, что до подписания агентством эта съёмка чаще всего
не нужна — честнее и в итоге приводит больше людей.
