 ...
 * Slug: newbrand/location-page
 * Categories: newbrand-pages
...
<!-- wp:gallery {"columns":3,"linkTo":"none","sizeSlug":"newbrand-sheet"} -->
<figure class="wp-block-gallery has-nested-images columns-3 is-cropped"><!-- wp:image {"sizeSlug":"newbrand-sheet"} -->
<figure class="wp-block-image size-newbrand-sheet"><img alt="Describe each photograph: who, doing what, where. Google Images sends real traffic to photographers."/></figure>
<!-- /wp:image --></figure>
<!-- /wp:gallery -->
